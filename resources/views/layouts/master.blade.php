...
<head>
    ...
    <title>Task Panel - Dashboard</title>
...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="{{asset('ui/vendor/chart.js/Chart.min.js')}}"></script>

    <!-- Page level custom scripts -->
    <script src="{{asset('ui/js/demo/chart-area-demo.js')}}"></script>
    <script src="{{asset('ui/js/demo/chart-pie-demo.js')}}"></script>
